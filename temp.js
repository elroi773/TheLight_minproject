const quotes = [
    ...
    { text: "나는 항상 소망을 품고 주를 더욱 더욱 찬송하리이다", author: "시편 71장 14절"},
    { text: "여호와는 그 얼굴을 네게로 향하여 드사 평강 주시기를 원하노라 할찌니라 하라", author:"민수기 6장 26절"},
    { text: "네가 복되고 형통하리로다", author:"시편 128편 2절"}
]; 